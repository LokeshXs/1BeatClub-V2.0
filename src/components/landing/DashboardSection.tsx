...
export default function DashboardSection() {
  ...
  <>
    <motion.section
      ...
      // }}
      className="   relative flex justify-center items-center px-6 max-sm:hidden "
    >
      <motion.img
...
{/* Mobile Section Dashboard section */}
      ...
      animate={{
        backgroundImage: [
          "radial-gradient(200% 120% at 50% 100%, transparent 60%, #b656f0cc)",
          "radial-gradient(200% 120% at 50% 100%, transparent 60%, #ff5f97cc)",
          "radial-gradient(200% 120% at 50% 100%, transparent 60%, #e7727bcc)",
        ],
      }}
      transition={{
        duration: 10,
      ...
      //   backgroundImage:"radial-gradient(110% 110% at 50% 0%, transparent 60%, #b656f0)"
      // }}
      className="   relative flex justify-center items-center px-6 sm:hidden "
    >
      <motion.img
        initial={{ y: 10, filter: "blur(10px)", opacity: 0 }}
        animate={{ y: 0, filter: "blur(0px)", opacity: 1 }}
      ...
      />
       <motion.img
        ...
        width={600}
        height={600}
        className=" rounded-md  -translate-y-28 sm:hidden  mask-b-from-[60%] "
      />
    </motion.section>
  </>
  );
