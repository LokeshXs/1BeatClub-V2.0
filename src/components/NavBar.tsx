    ...
    <MobileNavContextProvider>
      ...
      >
        <motion.nav
          ...
          className="  max-w-7xl mx-auto  flex justify-between items-center px-4 py-4 max-sm:py-3   rounded-xl mt-4 border-[1px] border-muted-foreground bg-secondary backdrop-blur-xl "
        >
          {/* <p className=" text-2xl max-md:text-xl max-sm:text-lg font-bold bg-gradient-to-r from-gradient-start via-gradient-via  to-gradient-end text-transparent bg-clip-text ">
            1BeatClub
          </p> */}
